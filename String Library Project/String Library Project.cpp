...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Mohammed Sami Al-Ghoraibi") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Mohammed Al-Ghoraibi", clsString::CapitalLetters)
        << endl << endl;

    //----------------

    String3.Value = "Welcome to Sanaa";
    cout << String3.Value << endl;
    ...
    //Tirms
    String3.Value = "    Mohammed Al-Ghoraibi     ";
    ...
    String3.Value = "Mohammed Sami Al-Ghoraibi";
    cout << "\nReplace : " << String3.ReplaceWordInStringUsingSplit("Mohammed", "Sami")
        << endl;
    ...
    String3.RemovePunctuationsFromString();
